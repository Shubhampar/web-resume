    ...
    <div className=" basis-1/2   text-left">
      ...
      <div>
        <div className="text-sm" style={{ color: theme.LtextColor }}>
          ...
          <div className="mt-1">
            ...
            <div className="flex items-center pt-2">
              ...
              <div>
                <Link
                  ...
                  href="https://www.linkedin.com/in/shubham-singh-86664094/"
                >
                  <p title="LinkedIn">Shubham Singh</p>
                </Link>
              </div>
            </div>
            {/* github */}
            <div className="flex items-center pt-2">
              <div className="pr-3">
                <Link target="_blank" href="https://github.com/Shubhampar">
                  <BsGithub size="1rem" style={{ color: theme.iconColor }} />
                </Link>
              </div>
              <div>
                <Link target="_blank" href="https://github.com/Shubhampar">
                  <p title="GitHub">Shubhampar</p>
                </Link>
              </div>
            </div>
            {/* portfolio */}
            <div className="flex items-center pt-2">
              ...
              <div>
                <Link target="_blank" href="https://shubhampar.github.io/">
                  <p title="Portfolio">Shubham Singh</p>
                </Link>
              </div>
            </div>
          </div>
      ...
      <div className="text-sm">
        ...
        <div>
          {/* company name  */}
          <div className="mt-1">
            <h1 className="text-base font-bold ">Ebt Pvt. ltd.</h1>
          ...
          <div className="mt-1">
            ...
            <ul
              ...
              style={{ color: theme.LtextColor }}
            >
              <li>Making Technical Customization as per Clients Requirement</li>
            </ul>
          </div>
        </div>
      </div>
